  ...
  head: () => ({
    meta: [
      ...
      { title: "Ashish Pipaliya — React Native Engineer" },
      {
        name: "description",
        content:
          "React Native engineer with 3+ years building scalable, high-performance mobile apps for brands like GNC, Kalki, and Bombay Shirt Company.",
      },
      { name: "author", content: "Ashish Pipaliya" },
      { property: "og:title", content: "Ashish Pipaliya — React Native Engineer" },
      {
        property: "og:description",
        content:
          "React Native engineer crafting scalable, high-performance mobile experiences.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#13111d" },
    ],
    links: [
